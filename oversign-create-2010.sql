...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2015 at 07:53 AM
...
CREATE TABLE IF NOT EXISTS `imageupload` (
  `ImageUploadID` int(11) NOT NULL,
  `ImagePath` varchar(100) NOT NULL,
  `ImageUploadAuthor` int(11) NOT NULL
...
--
ALTER TABLE `imageupload`
  MODIFY `ImageUploadID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
